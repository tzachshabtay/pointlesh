import { extendPointleshPrefab, isPointleshPrefab, type PointleshPrefabDefinition, type PointleshPrefabInstance, type PointleshProperties } from '@pointlesh/core';
