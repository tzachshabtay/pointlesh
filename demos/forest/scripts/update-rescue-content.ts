...
import { addForestObjectAssets, updateForestInteractions } from '../src/scene-content-updates.js';
...
addGuardAnimations(assets); addForestObjectAssets(assets); assertManifest(assets);
...
console.log('Updated dreamcap hotspot, runed chest object, and guard collapse animation.');
