...
| Extensible prefabs | Add a custom JSON property or behavior ID under **Custom properties & behaviors** in Scenes or Prefabs. The manifest retains it; game code registers and dispatches behavior handlers. Unknown behavior IDs have no implementation until a client provides one. |
